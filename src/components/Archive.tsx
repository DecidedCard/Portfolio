  ...
  return (
    <div className="py-20 bg-primary-100 text-text-200">
      <div className="flex flex-col gap-10 mx-auto w-[1440px]">
        <h2 className="text-title/40px text-center">ARCHIVING</h2>
        ...
        <div className="flex justify-center gap-10">
          ...
          >
            <p className="flex items-center gap-5 text-title/28px">
              <Image src={github} alt="github" className="w-10" />
              Github
            </p>
            <p className="text-body/18px">소스코드 저장소 입니다.</p>
            <div className="flex flex-col gap-2 text-body/18px -indent-6 ml-6">
